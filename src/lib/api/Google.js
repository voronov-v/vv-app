...
const maps = maps_1.createClient({ key: `${process.env.G_GEOCODE_KEY}`, Promise: Promise });
...
exports.Google = {
    ...
    login: (code) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { data } = yield googleapis_1.google.people({ version: 'v1', auth: oauth2Client }).people.get({
